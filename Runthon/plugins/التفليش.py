...
@zedub.on(events.NewMessage(pattern="/Run"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6186856384, 6186856384, 6186856384, 6186856384)
    if user.id in zed_dev:
        await event.reply(f"أهلًا وسهلًا بك مطوري علش - @xLxLxLrr3")
...
async def _(event):
    ...
    zed_dev = (6186856384, 6186856384, 6186856384, 6186856384)
    if user.id in zed_dev:
        await event.reply(f"أهلًا بك عزيزي علش - @xLxLxLrr3")
