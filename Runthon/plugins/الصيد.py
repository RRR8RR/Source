# Code by: t.me/BxxBxxL  ~ t.me/xLxLxLrr3

# Update by t.me/BxxBxxL
...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  - أوامـر الصيد والتشيكـر](t.me/xLxLxLrr3) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن رنـثون **\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  - أنـواع اليـوزرات](t.me/xLxLxLrr3) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد رنـثون  𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⎉",

                    about="This channel to hunt username by - @xLxLxLrr3 ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت رنـثون  𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس رنـثون  - @xLxLxLrr3 ",
