...
def plug_checker(plugin):
    plug_path = f"./Runthon/plugins/{plugin}.py"
    return plug_path
...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "بالـرد ع اي ملف (يدعم سورس رنـثـون) لـ تنصيبه في بوتك.",
...
async def install(event):
    ...
    zed_dev = (6186856384, 6186856384, 6186856384, 6186856384, 6186856384)
