...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/xLxLxLrr3) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐔𝐍𝐓𝐇𝐎𝐍─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 6186856384 or user.id == 6186856384 or user.id == 6186856384:
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐔𝐍𝐓𝐇𝐎𝐍- اوامـر التحشيش](t.me/xLxLxLrr3) 𓆪\n\n"
