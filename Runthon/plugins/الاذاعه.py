...
ZelzalPRO_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الاذا؏ـــة](t.me/xLxLxLrr3) 𓆪\n\n"
    ...
    "\n 𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 ](t.me/xLxLxLrr3) 𓆪"
)
...
async def gcast(event):
    ...
    if zedthon: #Write Code By T.me/BxxBxxL
    ...
    async for x in event.client.iter_dialogs():
        if x.is_group:
            chat = x.id
            try:
                if zelzal.text: #Write Code By T.me/BxxBxxL
                    try:
                    ...
                    try: #Write Code By T.me/BxxBxxL
