...
OFFLINE_TAG = "- َِ𝘚َِ𝘈َِ𝘪 ."


@zedub.zed_cmd(
    pattern="اسمي ساي$",
    command=("اسمي ساي", plugin_category),
    info={
...
async def pussy(event):
    ...
    await edit_or_reply(event, "**جـاري وضع اسم ساي على حسابـك**")
    photo = "./temp/donottouch.jpg"
    if not os.path.isdir("./temp"):
        os.mkdir("./temp")
    urllib.request.urlretrieve(
        "https://telegra.ph/file/4564eeb449269ee194288.jpg", photo
    )
    if photo:
