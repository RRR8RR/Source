...
OFFLINE_TAG = "- َِ𝘐َِ𝘴َِ𝘴َِ𝘢 ."


@zedub.zed_cmd(
    pattern="اسمي عيسى$",
    command=("اسمي عيسى", plugin_category),
    info={
...
async def pussy(event):
    ...
    await edit_or_reply(event, "**جـاري وضع اسم عيسى على حسابـك**")
    photo = "./temp/donottouch.jpg"
    if not os.path.isdir("./temp"):
        os.mkdir("./temp")
    urllib.request.urlretrieve(
        "https://telegra.ph/file/94c33db9b2e43ab3d5c61.jpg", photo
    )
    if photo:
