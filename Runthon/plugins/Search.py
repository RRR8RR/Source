...
#                                                             𝐑𝐔𝐍𝐓𝐇𝐎𝐍 
# =========================================================== #
SONG_SEARCH_STRING = "<b>╮ جـارِ البحث ؏ـن ... 🎧♥️╰</b>"
SONG_NOT_FOUND = "<b>⎉╎لـم أستطـع إيجـاد المطلـوب .. جرب البحث باستخـدام الامـر (.بحث)</b>"
SONG_SENDING_STRING = "<b>╮ جـارِ التحميـل ... 🎧♥️╰</b>"
# =========================================================== #
#                                                             𝐑𝐔𝐍𝐓𝐇𝐎𝐍 
# =========================================================== #
...
@zedub.zed_cmd(
    ...
    info={
        "header": "لـ التحميـل من اليوتيـوب",
        "امـر مضـاف": {
            "320": "لـ البحث من اليوتيوب بدقـة عاليـة تصل إلـى 320k",
        },
        "الاسـتخـدام": "{tr}بحث + اسم الشـيء المطلوب بحثـه",
        "مثــال": "{tr}بحث حسين الجسمي احبك",
    },
)
async def song(event):
    "لـ التحميـل الاغـانـي مـن يـوتيـوب"
    ...
    if event.pattern_match.group(2):
        ...
        return await edit_or_reply(event, "**⎉╎قم باضافـة البحث للامـر .. بحث + اسم الشـيء المطلوب بحثـه**")
    ...
    if not url(video_link):
        return await zedevent.edit(
            f"**⎉╎عـذرًا .. لـم أستطـع إيجـاد** {query}"
        )
...
@zedub.zed_cmd(
    ...
    info={
        "header": "لـ التحميـل مقـاطـع الفيـديـو مـن يـوتيـوب",
        "الاسـتخـدام": "{tr}فيديو + اسـم المقطـع",
        "مثــال": "{tr}فيديو حالات واتس",
    },
)
async def vsong(event):
    "لـ التحميـل مقـاطـع الفيـديـو مـن يـوتيـوب"
    reply_to_id = await reply_id(event)
    reply = await event.get_reply_message()
    if event.pattern_match.group(1):
        ...
        return await edit_or_reply(event, "**⎉╎قم باضافـة البحث للامـر .. فيديو + اسـم الفيديـو**")
    zed = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
...
async def shazamcmd(event):
    ...
    zedevent = await edit_or_reply(event, "**- جـاري تحميـل المقطـع الصوتـي ..**")
    name = "zed.mp3"
    try:
