#𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ®
#الملـف حقـوق وكتابـة علش  الهيبـه ⤶ @BxxBxxL خاص بسـورس ⤶ 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 𓆪 </b> - @xLxLxLrr3 "
...
async def who(event):
    ...
    if replied_user.id == 6186856384 or replied_user.id == 6367373783 or replied_user.id == 23839374791:
