...
LOGS = logging.getLogger("𝐬𝐨𝐮𝐫𝐜𝐞 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 ")
...
async def autovars(): #Code by T.me/BxxBxxL
...
async def autoname(): #Code by T.me/BxxBxxL
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/4edb726cd168c2f4e1654.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس تيـبثون الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝐬𝐨𝐮𝐫𝐜𝐞 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 𓅛", "https://t.me/xLxLxLrr3"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/xLxLxLrr3.jpg")
